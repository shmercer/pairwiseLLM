...
comparisons. Instead of allocating comparisons uniformly at random, the within-set controller uses
current rank, uncertainty, coverage, and degree information to choose each next pair.
...
> Mercer, S. H. (2026). *pairwiseLLM: Pairwise writing quality comparisons with large language models* (Version 1.3.2) [R package; Computer software]. https://github.com/shmercer/pairwiseLLM
