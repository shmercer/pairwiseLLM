...
Use the unified API for direct API calls. The `submit_llm_pairs()` function supports **parallel processing** and **incremental output saving** for the OpenAI, Anthropic, Gemini, and Together backends.
