...
For data schemas, prompt management, provider controls, recovery, and Bayesian BTL, see:
...
- **Design: Adaptive Pairing**
  `vignette("within-set-adaptive-design")`
- **Guide: Adaptive Linking**
  `vignette("adaptive-linking")`
- **Design: Adaptive Linking**
  `vignette("adaptive-linking-design")`
