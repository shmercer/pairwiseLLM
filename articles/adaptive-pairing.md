...
The executable ranking chunks below run when CmdStan is available. The
deterministic judge is local, so the example never makes a network
request or incurs provider charges.
