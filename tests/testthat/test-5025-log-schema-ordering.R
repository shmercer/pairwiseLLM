test_that("canonical log schemas follow the expected column order", {
  ...
  expected_link_stage <- c(
    ...
    "reliability_EAP_link", "reliability_link_global", "reliability_stop_pass", "linking_identified",
    "lag_eligible", "link_lag_eligible", "link_min_refit_eligible", "link_stop_gate_open",
    "rank_stability_lagged", "rank_stability_pass",
    "link_stop_eligible", "stop_consecutive_pass_count", "link_stop_pass", "transform_frozen",
    ...
    "theta_global_rmse_lagged", "probe_edges_min_for_stop_used",
