test_that("canonical log schemas follow the expected column order", {
  expected_step <- c(
    ...
    "raw_response_json",
    "round_id", "round_stage", "pair_type", "pairing_strategy", "target_distance",
    "used_in_round_i", "used_in_round_j",
    ...
    "n_candidates_generated", "n_candidates_after_route_filters",
    "n_candidates_after_active_domain", "n_candidates_after_stage_filters",
    "n_candidates_after_exposure_filters", "n_candidates_after_hard_filters",
  ...
  expected_link_stage <- c(
    ...
    "phase_a_hub_hash",
    "phase_a_spoke_hash",
    "phase_a_hub_artifact_hash",
    "phase_a_spoke_artifact_hash",
    "phase_a_hub_source_evidence_hash",
    "phase_a_spoke_source_evidence_hash",
    "phase_a_hub_kind",
    "phase_a_spoke_kind",
    "phase_a_hub_source_count",
    "phase_a_spoke_source_count",
    "phase_a_hub_payload_count",
    "phase_a_spoke_payload_count",
    "cross_evidence_hash",
    "delta_spoke_lower",
    "delta_spoke_upper",
    "fit_reused",
    ...
    "delta_change_lagged", "log_alpha_change_lagged",
    "reliability_link_global", "link_stop_reliability_min_used", "reliability_stop_pass",
    "linking_identified",
    ...
    "phase_b_global_metric_uncertainty_approximation",
    ...
    "escalation_recent_pass_count", "escalation_recent_window_size", "escalated_this_refit",
    ...
    "feasibility_budget_released", "feasibility_reallocation_used",
    "feasibility_reallocation_rule",
    "stage_realized_anchor_link", "stage_realized_long_link",
    ...
    "stage_reallocation_used", "stage_reallocation_rule_used", "stage_budget_unfilled",
    ...
    "long_link_taper_applied", "stage_target_long_link_pre_taper", "stage_target_long_link_post_taper",
    ...
    "concurrent_utility_mass", "concurrent_top_k_used", "concurrent_candidate_count",
