...
test_that("append_step_log validates column names and fills missing columns", {
  ...
  expect_true(is.character(out$i_id))
  expect_true(is.na(out$i_id))
  expect_true(is.character(out$status))
  expect_true(is.na(out$status))
  expect_true(is.character(out$judge_backend))
  expect_true(is.na(out$judge_backend))
  expect_true(is.logical(out$judge_valid))
  expect_true(is.na(out$judge_valid))
  expect_true(is.double(out$prompt_tokens))
  expect_true(is.na(out$prompt_tokens))
  expect_true(is.character(out$raw_response_json))
  expect_true(is.na(out$raw_response_json))
