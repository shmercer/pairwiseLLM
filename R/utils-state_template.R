...
.bt_state_template <- function() {
  tibble::tibble(
    ...
    pct_nodes_with_degree_gt0 = double(),
    ...
    new_n_components = integer(),
    new_largest_component_frac = double(),
    new_degree_min = double(),
    new_degree_median = double(),
    new_pct_nodes_with_degree_gt0 = double(),
