...
schema_step_log <- c(
  ...
  stage_quota = "integer",
  stage_committed_before = "integer",
  stage_committed_after = "integer",
  round_committed_before = "integer",
  round_committed_after = "integer",
...
schema_round_log <- c(
  ...
  p_adj_median = "double",
  uncertainty_concentration = "double",
  top_boundary_uncertainty = "double",
  adjacent_separation_uncertainty = "double",
