...
schema_link_stage_log <- c(
  ...
  spoke_set_id = "character",
  hub_set_id = "character",
  config_hash = "character",
  input_hash = "character",
  phase_a_hub_hash = "character",
  phase_a_spoke_hash = "character",
  phase_a_hub_artifact_hash = "character",
  phase_a_spoke_artifact_hash = "character",
  phase_a_hub_source_evidence_hash = "character",
  phase_a_spoke_source_evidence_hash = "character",
  phase_a_hub_kind = "character",
  phase_a_spoke_kind = "character",
  phase_a_hub_source_count = "integer",
  phase_a_spoke_source_count = "integer",
  phase_a_hub_payload_count = "integer",
  phase_a_spoke_payload_count = "integer",
  cross_evidence_hash = "character",
  delta_spoke_lower = "double",
  delta_spoke_upper = "double",
  fit_reused = "logical",
  fit_attempted = "logical",
  fit_valid = "logical",
  convergence_code = "integer",
  hessian_pd = "logical",
  covariance_valid = "logical",
  covariance_jitter = "double",
  warning_code = "character",
  failure_code = "character",
  uncertainty_scope = "character",
  ...
  probe_near_boundary_frac = "double",
  probe_near_boundary_min_frac_used = "double",
  probe_near_boundary_pass = "logical",
  probe_extreme_frac = "double",
  probe_extreme_max_frac_used = "double",
  probe_extreme_frac_pass = "logical",
  probe_midrange_frac = "double",
  probe_midrange_min_frac_used = "double",
  probe_midrange_pass = "logical",
  probe_unique_hub_items = "integer",
  probe_unique_hub_min_used = "integer",
  probe_unique_hub_pass = "logical",
  probe_unique_spoke_items = "integer",
  probe_unique_spoke_min_used = "integer",
  probe_unique_spoke_pass = "logical",
  probe_rank_bins_hub_covered = "integer",
  probe_rank_bins_hub_min_used = "integer",
  probe_rank_bins_hub_pass = "logical",
  probe_rank_bins_spoke_covered = "integer",
  probe_rank_bins_spoke_min_used = "integer",
  probe_rank_bins_spoke_pass = "logical",
  probe_brier_near_boundary = "double",
  probe_brier_near_boundary_max_used = "double",
  probe_brier_near_boundary_pass = "logical",
  probe_ece = "double",
  probe_ece_max_used = "double",
  probe_ece_pass = "logical",
  probe_quality_pass = "logical",
  probe_quality_blocker_codes = "character",
