...
#' reduced artifact cannot recover its audit through this function. SVR support
#' vectors retain numeric matrix dimensions and feature order as necessary
#' deployment data; audit omission does not anonymize them.
#'
...
#' @seealso [save_warm_start_model()], [register_warm_start_model()]
#' @examples
