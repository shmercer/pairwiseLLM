...
#' validates artifacts without a fitting backend or Python; corrupt entries produce errors
...
#' @seealso [save_warm_start_model()], [load_warm_start_model()], [ensemble_warm_start_models()]
#' @examples
