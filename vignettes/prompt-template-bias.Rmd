...
This section describes the historical experiment bundled with pairwiseLLM
1.3.0. It is not a catalog of currently available models. In particular,
`gemini-3-pro-preview` is now retired, and the old Together identifiers below
are retained only to identify archived result rows.
...
For Together.ai we ran positional-bias experiments using the Chat Completions 
API (/v1/chat/completions) for the following models:
