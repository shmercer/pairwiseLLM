...
For a full worked example of prompt-template testing and positional-bias analysis, see:
...
If you use these batch workflows or related diagnostics in published work, please cite:
