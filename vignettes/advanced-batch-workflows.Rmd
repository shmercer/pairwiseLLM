...
```{r logo, echo = FALSE, warning = FALSE, message = FALSE, fig.align = "center", out.width = "100%"}
knitr::include_graphics(
  system.file("images", "pairwiseLLM_logo.jpeg", package = "pairwiseLLM")
)
```

<br>
<h1 style="text-align: center;">Advanced: Submitting and Polling Multiple Batches</h1>
<br>
