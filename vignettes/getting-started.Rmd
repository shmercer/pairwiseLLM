...
It now supports **parallel processing** and **incremental output file saving** (resume capability) for cloud backends. The function returns a list containing `$results` (successful comparisons) and `$failed_pairs` (errors).
