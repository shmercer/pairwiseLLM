...
function. Despite its name, this function does not change a global
active template. Keep custom template files in your own project, rather
than editing the installed package. Use
...
to manage named templates for the current session.
