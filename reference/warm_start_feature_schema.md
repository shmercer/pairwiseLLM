...
require a new schema identifier rather than silently modifying an
existing schema. Optional Python software is needed only for extraction,
not schema inspection or prediction from precomputed features.
