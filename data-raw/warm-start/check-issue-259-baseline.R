# Focused baseline collection, not a full-package coverage claim.
# Rscript --vanilla data-raw/warm-start/check-issue-259-baseline.R /tmp/issue259-phase1
...
local({
  ...
  if (length(arguments) == 1L) {
    ...
    writeLines(c(
      ...
      '  filter = "^(0031|010[0-9]|011[0-3]|310[0-2]|510[015]|910[0-2])-",',
