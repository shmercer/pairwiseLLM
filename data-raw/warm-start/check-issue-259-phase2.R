# Focused Phase 2 collection, not a full-package coverage claim.
# Rscript --vanilla data-raw/warm-start/check-issue-259-phase2.R /tmp/issue259-phase2
...
local({
  ...
  if (length(arguments) == 1L) {
    ...
    writeLines(c(
      ...
      '  filter = "^(0031|010[0-9]|011[0-4]|310[0-27]|510[015]|910[0-24])-",',
