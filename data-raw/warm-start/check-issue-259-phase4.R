# Focused Phase 4 collection, not a full-package coverage claim.
# Rscript --vanilla data-raw/warm-start/check-issue-259-phase4.R /tmp/issue259-phase4
...
local({
  ...
  if (length(arguments) == 1L) {
    ...
    writeLines(c(
      ...
      '  filter = "^(0031|010[0-9]|011[0-6]|310[0-27]|510[015]|910[0-24])-",',
